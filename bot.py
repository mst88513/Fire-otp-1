...
# ==========================================
TOKEN = "8509722859:AAG_VUlyNn9O59azH35KqknGLkSMBkIXpSE"
BASE_URL = f"https://api.telegram.org/bot{TOKEN}"
FILE_URL = f"https://api.telegram.org/file/bot{TOKEN}/"

OWNER_ID = 8015509191
BOT_USERNAME = "@fireotpbot1_bot"
...
firebase_credentials_json = r"""
{
  ...
  "project_id": "hadisms-f9cfd",
  "private_key_id": "8989d3abcbd675e8fa4e7db499db1ba5d782dfa6",
  "private_key": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
  "client_email": "firebase-adminsdk-fbsvc@hadisms-f9cfd.iam.gserviceaccount.com",
  "client_id": "103838207387368501516",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40hadisms-f9cfd.iam.gserviceaccount.com",
...
def mask_number(num):
    clean = num.replace("+", "").replace(" ", "")
    if len(clean) > 6: return f"{clean[:3]}❖আহ❖{clean[-3:]}"
    elif len(clean) > 2: return f"{clean[:1]}❖আহ❖{clean[-1:]}"
    return clean
...
def handle_callback(call):
    # 👇 এডমিন চেক - একদম প্রথমে যোগ করুন
    chat_id = call["message"]["chat"]["id"]
    data = call.get("data", "")
    
    # সব এডমিন ক্যালব্যাকের লিস্ট
    admin_callbacks = [
        "system_settings", "manage_fj", "manage_admins", "manage_otp_groups",
        "manage_panels", "dxa_control", "manage_emojis", "user_management",
        "menu_design_list", "stex_control", "voltx_control", "broadcast_msg",
        "upload_num", "delete_files", "show_used", "show_unused", "back_to_admin",
        "lb_main", "manage_api_panels", "manage_cpt_panels", "add_api_panel",
        "add_cpt_panel", "list_del_api", "list_del_cpt", "del_adm_", "add_adm",
        "lb_", "nx_", "vx_"
    ]
    
    is_admin_callback = any(data.startswith(cb) for cb in admin_callbacks)
            ...
            try:
                ...
                if doc.exists:
                    ...
                    if chat_id in admins:
                        is_admin_now = True
                        if chat_id not in bot_settings["admins"]:
                            bot_settings["admins"].append(chat_id)
            except:
                pass
        
        if not is_admin_now:
            is_admin_now = chat_id in bot_settings["admins"]
        
        if not is_admin_now:
            answer_callback(call["id"], "❌ You are not an admin!", show_alert=True)
            try:
    ...
    # 👇 বাকি আপনার পুরনো কোড চালাতে থাকবে
    global total_assigned_stats
    chat_type = call["message"]["chat"].get("type", "private")
    #← এই লাইন ডিলিট করুন (উপরে ডিফাইন করা আছে)
    # chat_id = call["message"]["chat"]["id"]  ← এই লাইন ডিলিট করুন (উপরে ডিফাইন করা আছে)
